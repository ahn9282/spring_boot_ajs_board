...
<head>
    ...
    <link href="${pageContext.request.contextPath}/css/price-rangecss" rel="stylesheet">
...
<body>
	...
	<c:url value="/shopper/login" var="loginUrl" />
			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form:form name="f" action="${loginUrl}">
							<input type="text" name="id" placeholder="Name" />
							<input type="text" name="pw" placeholder="Email Address" />
							   <c:if test="${param.error != null}">
        							<p class="wrong">아이디와 비밀번호가 잘못되었습니다.</p>
   								 </c:if>
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form action="${pageContext.request.contextPath}/shopper/insertUser" method="post">
